...
<!-- Mirrored from demo.devitems.com/greenfarm-v1/greenfarm/compare.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Dec 2019 10:51:15 GMT -->
<head>
	<meta charset="utf-8">
				...
				<div class="row">
					<div class="col-md-3 col-sm-12 col-xs-12 text-lg-left text-md-center text-sm-center">
						...
						<div class="logo mt-15 mb-15">
							<a href="index.html">
								<img src="assets/images/logo-login.png" class="img-fluid" alt="">
							</a>
						</div>
						<!-- end of logo -->
					</div>
							...
							<table class="table mb-0">
								<tbody>
									<tr>
										...
										<td class="product-image-title">
											<a href="#" class="image"><img src="assets/images/products/product02.jpg" class="img-fluid" alt="Compare Product"></a>
											<a href="#" class="category">Fruit</a>
											<a href="#" class="title">Auctor gravida pellentesque</a>
										</td>
										<td class="product-image-title">
											<a href="#" class="image"><img src="assets/images/products/product03.jpg" class="img-fluid" alt="Compare Product"></a>
